...
The **bretigeaMarkerAddition** function makes use of a modified **findCells** function from *BRETIGEA* R package to a graph of the significance of the cell type proportion
...
```r 
  ...
  bretigeaMarkerAddition <- CellTyPETool::bretigeaMarkerAddition(
    countDf = countDf,
  ...
  bretigeaMarkerAddition  
    
  calcAndCompare <- CellTyPETool::calcAndCompare (
    countDf = countDf,
    mgpCellMarkers = mgpCellMarkers,
    bretCellMarkers = bretCellMarkers)
  
  calcAndCompare$corrPlot
  
  estimatesVPathBret <- CellTyPETool::estimatesVPath(
  ...
  estimatesVPathMGP <- CellTyPETool::estimatesVPath(
   ...
   genesUsed <- CellTyPETool::genesUsed(
    countDf = countDf,
    mgpCellMarkers = mgpCellMarkers,
    bretCellMarkers = bretCellMarkers)
```
...
<div style="text-align:center"><img src="bretigeaMarkerAddition" alt="LinePlot_16Nov2020" width="450"/>
<div style="text-align:left">

<div style="text-align:center"><img src="corrPlot" alt="CorrPlot_16Nov2020" width="450"/>
<div style="text-align:left">

<div style="text-align:center"><img src="estimatesVPathBret" alt="VolcanoPlot_16Nov2020" width="450"/>
<div style="text-align:left">
